...
const helloWorld: number[] = [ 1, ...Array.from({ length: 5 - 2 + 1 }, (_ReservedX, _ReservedI) => _ReservedI + 2) ];
`.trim();

const expectedOutputJS = `
const helloWorld = [ 1, ...Array.from({ length: 5 - 2 + 1 }, (_ReservedX, _ReservedI) => _ReservedI + 2) ];
`.trim();
