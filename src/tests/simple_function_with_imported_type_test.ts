...
function isTrue<a>(value: Maybe.Maybe<a>): boolean {
    if (value) {
        return true;
    } else {
        return false;
...
export function testParse() {
    assert.deepStrictEqual(
        ...
        Module(
            ...
            [
                Function(
                    ...
                    [
                        FunctionArg(
                            "value",
                            FixedType("Maybe.Maybe", [ GenericType("a") ])
                        ),
                    ],
                    [ ],
                    IfStatement(
            ...
            [
                "Error on lines 0 - 2\n" +
                    "Type Maybe.Maybe (a) did not exist in the namespace:\n" +
                    "```\n" +
                    "isTrue: Maybe.Maybe a -> boolean\n" +
                    "isTrue value = if value then true else false\n" +
                    "```",
