...
function mergeNames(first: Names, second: Names): Names {
    const modules: Seen[] = List.foldr(
        mergeSeen,
        [],
        List.append(first.modules, second.modules)
    );
    const values: Seen[] = List.foldr(
        mergeSeen,
        [],
...
function flattenNames(names: Names[]): Names {
    return List.foldr(
        function (currentNames: any, finalNames: any) {
...
function namesToCollisions(names: Names): Collision[] {
    ...
    const moduleCollisions: Collision[] = List.foldr(
        collisionStep,
        [],
        names.modules
    );
    const valueCollisions: Collision[] = List.foldr(
        collisionStep,
        [],
        names.values
    );
